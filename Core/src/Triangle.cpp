...
int mainT() {
	...
	// Variable para guardar el estado de compilaci�n
	int success;
	// String para almacenar informaci�n en caso de haber errores
	char infoLog[512];
	// Obtener el estado de compilaci�n y guardarlo en success
	...
	// ShaderProgram es una combinaci�n de varios shaders
	...
	// Ya no necesitamos los shaders que creamos as� que los eliminamos
	...
	// Copia los datos de los v�rtices al buffer
	...
	// en la posici�n 0 (primer arg), que son 3 datos, que es un float, que cada 3 floats es uno de los atributos
